...
export class AmazonSpApiAuthService {
  private readonly logger = createLogger('AmazonSpApiAuthService');
  ...
  constructor() {
    this.clientId = process.env.AMAZON_SP_API_CLIENT_ID || null;
    this.clientSecret = process.env.AMAZON_SP_API_CLIENT_SECRET || null;
    this.refreshToken = process.env.AMAZON_SP_API_REFRESH_TOKEN || null;
  }
